...
export default function GingerPage() {
  return (
    <>
      {/* HERO */}
      <section style={{ background: "#2C1A0E", padding: "8rem clamp(1.5rem,5vw,4rem) clamp(4rem,8vw,6rem)", position: "relative", overflow: "hidden" }}>
  <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 50% 70% at 90% 50%, rgba(200,168,130,0.15) 0%, transparent 60%)" }} />
